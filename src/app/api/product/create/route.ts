...
export async function POST(req: Request) {
  ...
  //     imagesFilesArray.push(image);
  //   }
  // });
  // console.log(
  //   '🚀 ~ file: route.ts:41 ~ images.forEach ~ imagesFilesArray:',
  //   imagesFilesArray
  // );

  // const [uploadThumbnail, uploadImages] = await Promise.all([
  //   uploadthingApi.uploadFiles(thumbnail).then((res) => {
  ...
  //   }),
  //   uploadthingApi.uploadFiles(images).then((res) => {
  //     console.log('🚀 ~ file: route.ts:27 ~ .then ~ res:', res);
  ...
  // ]);
  // console.log(
  //   '🚀 ~ file: route.ts:45 ~ POST ~ uploadThumbnail:',
  //   uploadThumbnail
  // );
  // console.log('🚀 ~ file: route.ts:26 ~ POST ~ uploadImages:', uploadImages);
